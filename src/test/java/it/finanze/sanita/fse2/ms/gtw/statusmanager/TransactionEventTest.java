...
//import it.finanze.sanita.fse2.ms.gtw.statusmanager.dto.KafkaStatusMessageDTO;
...
//
//
//			km = KafkaStatusMessageDTO.builder().validationInfo(validationEvent)
...
//
//
//			km = KafkaStatusMessageDTO.builder().publicationInfo(publicationInfo).publicationResult(PublicationResultEnum.PUBLISHING_ERROR)
//					.build();
//
//			key = "P";
//		}
...
//
//
//			km = KafkaStatusMessageDTO.builder().validationInfo(validationEvent).validationResult(ValidationResultEnum.OK).build();
//			key = "HV";
//		} else {
//
//			PublicationInfoDTO publicationInfo = PublicationInfoDTO.builder().transactionID(transactionID)
...
//
//
//			km = KafkaStatusMessageDTO.builder().publicationInfo(publicationInfo).publicationResult(PublicationResultEnum.OK).build();
//
//			key = "HP";
//		}
//
