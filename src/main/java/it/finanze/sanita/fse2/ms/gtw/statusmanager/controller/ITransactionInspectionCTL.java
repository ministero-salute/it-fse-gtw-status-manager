...
public interface ITransactionInspectionCTL {

	@GetMapping("/{transactionID}")
	@Operation(summary = "Recupero dettaglio transazione", description = "Recupera il dettaglio degli eventi e dello stato di una transazione.")
	...
	@GetMapping("/find")
	@Operation(summary = "Recupero dettaglio transazione in base ai filtri forniti", description = "Recupera il dettaglio degli eventi e dello stato di una transazione in base ai filtri di ricerca forniti.")
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Transaction found"),
			...
			@ApiResponse(responseCode = "404", description = "Transaction not found"),
			@ApiResponse(responseCode = "500", description = "Internal Server Error") })
	TransactionsResponseDTO findTransaction(@RequestParam(required = false) ValidationResultEnum lastValidationResult,
											@RequestParam(required = false) PublicationResultEnum lastPublicationResult,
											@RequestParam(required = false) EventTypeEnum lasEventType,
											@RequestParam(required = false) EventTypeEnum eventType,
											@RequestParam(required = false) ValidationResultEnum eventValidationResult,
											@RequestParam(required = false) PublicationResultEnum eventPublicationResult,
